              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (user.englishLevel.isNotEmpty)
                      Container(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 10, vertical: 4),
                        decoration: BoxDecoration(
    ...
    return StreamBuilder<Map<String, bool>>(
      ...
      builder: (context, snapshot) {
        final toggles = snapshot.data ??
            {'listening': true, 'speaking': true, 'daily_challenge': true};
        ...
        final cards = <Widget>[
          ...
          if (toggles['listening'] ?? true)
            _QuickCard(
              icon: Icons.headphones_rounded,
              label: 'Listening',
              color: AppColors.primaryDark,
              onTap: () => context.go(AppRoutes.studentListening),
            ),
          if (toggles['speaking'] ?? true)
            _QuickCard(
