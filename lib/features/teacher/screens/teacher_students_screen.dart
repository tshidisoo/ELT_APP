...
class _TeacherStudentsScreenState
  ...
  String? _filterLevel; // null = show all
      ...
      body: NestedScrollView(
        ...
        body: StreamBuilder<List<UserModel>>(
          ...
          builder: (context, snapshot) {
            ...
            // Filter by level then sort
            final students = raw
                .where((s) =>
                    _filterLevel == null || s.englishLevel == _filterLevel)
                .toList();
            if (_sortByXp) {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      if (student.englishLevel.isNotEmpty)
                        Container(
                          padding: const EdgeInsets.symmetric(
