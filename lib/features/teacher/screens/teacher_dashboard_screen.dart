                    ...
                    children: [
                      ...
                      const Column(
                        ...
                        children: [
                          ...
                          Text('Manage your English class',
                              style: TextStyle(
            ...
            child: Column(
              children: [
                _FeatureToggleRow(
                  ...
                  description: 'Audio exercises for each unit',
                  color: const Color(0xFF0D9488),
                  enabled: toggles['listening'] ?? true,
                  onChanged: (v) => service.setFeature('listening', v),
                ),
                const Divider(height: 24),
                _FeatureToggleRow(
                  icon: Icons.record_voice_over_rounded,
                  label: 'Speaking Practice',
                  description: 'Spin-wheel speaking topics',
                  color: const Color(0xFF0EA5E9),
                  enabled: toggles['speaking'] ?? true,
                  onChanged: (v) => service.setFeature('speaking', v),
                ),
                const Divider(height: 24),
                _FeatureToggleRow(
    ...
    return GridView.count(
      ...
      children: [
        ...
        _ActionCard(
          ...
          color: AppColors.primary,
          onTap: () => context.go(AppRoutes.teacherListening),
        ),
      ],
    );
  }
