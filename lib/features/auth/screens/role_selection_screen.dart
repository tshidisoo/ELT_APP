...
class _RoleSelectionViewState extends State<_RoleSelectionView> {
  ...
  void _selectRole(String role) {
    setState(() {
      ...
      // Reset level selection when switching role
  ...
  void _confirm() {
    ...
    if (_selectedRole == AppConstants.roleStudent &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text(AppStrings.errorLevelRequired)),
      );
      return;
    }
              ...
              children: [
                ...
                if (_selectedRole == AppConstants.roleStudent) ...[
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    hint: const Text(AppStrings.levelHint),
                    decoration: const InputDecoration(
                      prefixIcon: Icon(Icons.menu_book_rounded),
                    ),
                    items: AppConstants.allLevels
